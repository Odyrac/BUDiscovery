...
export default function GameControllerScreen({ navigation, route }) {
    ...
    function navigateToGameController(chapter, finalScore) {
        ...
        navigation.push('GameController', { language: route.params.language, scenario: route.params.scenario, startingPoint: route.params.startingPoint, chapter: chapter, questNumber: questNumber, startTimestamp: timestamp, score: finalScore});
    }


    if (chapter === 1) {
        return (
            <Chapter startTimestamp={timestamp} navigation={navigation} scenario={route.params.scenario} language={route.params.language} avatarImage='main' endFunction={() => changeChapter()} string1={scenarioStrings.startingPoint1} string2={scenarioStrings.startingPoint2} string3={scenarioStrings.startingPoint3} string4={scenarioStrings.startingPoint4} startingPoint={route.params.startingPoint} quest1Level0={scenarioStrings.startingPointQuest1Level0} quest1Level1={scenarioStrings.startingPointQuest1Level1} quest2Level0={scenarioStrings.startingPointQuest2} quest2Level1={scenarioStrings.startingPointQuest2} quest2Placeholder={scenarioStrings.startingPointQuest2Placeholder} quest2Error={scenarioStrings.startingPointQuest2Error} quest2AnswerLevel0={scenarioStrings.startingPointQuest2AnswerLevel0} quest2AnswerLevel1={scenarioStrings.startingPointQuest2AnswerLevel1} questNumber={questNumber} quest1Button={appStrings.buttonHereWeAre} />
        )
        ...
        return (
            <Chapter startTimestamp={timestamp} navigation={navigation} scenario={route.params.scenario} language={route.params.language} avatarImage='main' endFunction={() => changeChapter()} string4={scenarioStrings.endBeforeQuiz} startingPoint={route.params.startingPoint} />
        )

    } else if (chapter === 8) {
        return (
            <Quiz startTimestamp={timestamp} navigation={navigation} scenario={route.params.scenario} language={route.params.language} endFunction={(finalScore) => changeChapter(finalScore)} startingPoint={route.params.startingPoint} />
        )

    } else if (chapter === 9) {
        return (
            <Chapter score={score} navigation={navigation} scenario={route.params.scenario} language={route.params.language} avatarImage='good' endFunction={() => navigation.navigate('Home')} string1={scenarioStrings.quizEnd} string4={appStrings.gameEnd} startingPoint={route.params.startingPoint} />
        )
